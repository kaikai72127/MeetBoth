		...
		<div id="main">
			<div class="inner">
				...
				<section>
					...
					<form action="<c:url value='/_03_product.insertProduct.controller' />"
						...
						<div class="table-wrapper">
							<table>
								<thead>
									...
									<tr>
										<td><h3>商品介紹:</h3> <textarea id="directions" name="directions" placeholder="(最多500字)"></textarea></td>
									</tr>
									<tr>
										<td><h3>商品照片:</h3> <input type="file" name="pPic"
											id="images5278" style="width: 80%" accept=".jpg,.png"></td>
									</tr>
									<tr>
