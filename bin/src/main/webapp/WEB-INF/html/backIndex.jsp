...
String log = null;
if (user == null) {
	String target = "/SpringMVC_Team5/_01_member.Login";
	log = "<a href="+ target + "/><span class=label>"
	+ "<i class=\"fa-solid fa-right-to-bracket\"></i></span>登入</a>";
} else {
	String target = "/SpringMVC_Team5/_01_member.Logout";
	log = "歡迎您！" + user + "<a href=" + target + "><span class=\"label\">"
