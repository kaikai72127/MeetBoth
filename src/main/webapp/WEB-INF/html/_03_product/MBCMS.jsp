									...
									<div class="post-video embed-responsive embed-responsive-16by9"
										...
										<div>
											<span>網站名稱 :&ensp;</span><span id="MBSPAN">肉丸學習網
												...
												id="MBText" style="display: none" />
											<input type="button" value="修改" class="MBbtn" id="MBUpDate" />
											<input type="button" value="確認" class="MBbtn" id="MBCommit"
												style="display: none" />
										</div>
										<div>
											<span>網站首頁網址 :&ensp;</span><span><a
												href="#" id="webSPAN">MeetBoth/index.controller</a></span>
											<input type="text" value="" class="MBinput" id="webText"
												style="display: none; width: 500px" />
											<input type="button" value="修改" class="MBbtn" id="webUpDate" />
