							...
							<div class="post">
								...
								<div class="post">
									<div class="post-video embed-responsive embed-responsive-16by9"
										...
										<div style="display: flex">
											<button class="MBbtn"
												onclick="window.location='/MeetBoth/admin/_03_product.productindex.controller/1'">返回</button>
											<button class="MBbtn"
												onclick="window.location='/MeetBoth/admin/_03_product.pathToMBinsertProd.controller?id=${prod.prodID}'">修改</button>
