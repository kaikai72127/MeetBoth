	...
	<div id="wrapper">
		...
		<div id="main">
			<div class="inner">
				<!-- Header -->
				<header id="header">
					<a href="/index.controller" class="logo"><strong>後台管理系統</strong></a>
				</header>
							...
							<form action='<c:url value="/_05_teacStu.insertdata.controller" />' enctype='multipart/form-data' method='post'>
								<table class="alt">
									<thead>
										...
										<tr><td><input name="memberId" type="text" onkeyup="value=value.replace(/[^\d]/g,'') " style="width:80%" required></td></tr>
										<tr><td>請輸入貼文標題：</td></tr>
										...
										<br>
										<img id="preImg" style="width:150px; height:200px" src="http://localhost:8080/SpringMVC_Team5/WEB-INF/resources/images/meatball-200.png" />
										</td></tr>
									</thead>
									...
									<input type="button" value="取消" onclick="location.href='http://localhost:8080/SpringMVC_Team5/_05_teacStu.searchAllTeac.controller'">
									</div>
									</form>
							</div>
				</section>
