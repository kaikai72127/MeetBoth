            ...
            <div class="resume-body">
                <div class="resume-section">
                    ...
                    <div class="resume-table">
                        <div class="resume-item">
                            ...
                            <div class="resume-item-content"><input name="highEdu" value="${bean.highEdu}" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的學歷...Ex:銘傳大學財務金融學系"></div>
                        </div>
                        <div class="resume-item">
                            <div class="resume-item-title">家教經驗</div>
                            <div class="resume-item-content">
                                <input name="studExp" value="${bean.studExp}" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的家教經驗...Ex:國中數學2年">
                            </div>
                        </div>
                        <div class="resume-item">
                            <div class="resume-item-title">留學經驗</div>
                            <div class="resume-item-content"><input name="tutorExp" value="${bean.tutorExp}" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的留學經驗...Ex:美國念MBA2年"></div>
                        </div>
                        <div class="resume-item">
                            <div class="resume-item-title">語言能力</div>
                            <div class="resume-item-content"><input name="lanAbility" value="${bean.lanAbility}" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的語言能力...Ex:英文:精通"></div>
                        </div>
                        <div class="resume-item">
                            <div class="resume-item-title">證照技能</div>
                            <div class="resume-item-content"><input name="skills" value="${bean.skills}" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的證照技能...Ex:國際專案管理師PMP"></div>
                        </div>
                    </div>
                    ...
                    <div class="resume-table">
                        <div class="resume-table">
                            <div class="resume-item">
                                ...
                                <div class="resume-item-content"><input name="subjectItem" value="${bean.subjectItem}" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的授課科目...Ex:英文、數學"></div>
                            </div>
                            <div class="resume-item">
                                <div class="resume-item-title">授課地區</div>
                                <div class="resume-item-content"><input name="teacLoc" value="${bean.teacLoc}" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的授課地區...Ex:台北市、新北市"></div>
                            </div>
                            <div class="resume-item">
                                <div class="resume-item-title">授課對象</div>
                                <div class="resume-item-content"><input name="teacObject" value="${bean.teacObject}" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的授課對象...Ex:國小、國中"></div>
                            </div>
                            <div class="resume-item">
                                <div class="resume-item-title">授課時段</div>
                                <div class="resume-item-content"><input name="teacTime" value="${bean.teacTime}" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的授課時段...Ex:平日早上、平日下午"></div>
                            </div>
                            <div class="resume-item">
                                <div class="resume-item-title">授課模式</div>
                                <div class="resume-item-content"><input name="classMode" value="${bean.classMode}" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的授課模式...Ex:面授、線上教學"></div>
                            </div>
                            <div class="resume-item">
                                <div class="resume-item-title">試教意願</div>
                                <div class="resume-item-content"><input name="willTeac" value="${bean.willTeac}" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的試教意願...Ex:可試教或不方便試教"></div>
                            </div>
                            <div class="resume-item">
                                <div class="resume-item-title">聯絡方式</div>
                                <div class="resume-item-content"><input name="conMethod" value="${bean.conMethod}" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的連絡方式...Ex:電話、郵件"></div>
                            </div>
                            <div class="resume-item">
                                <div class="resume-item-title">聯絡時間</div>
                                <div class="resume-item-content"><input name="conTime" value="${bean.conTime}" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的聯絡時間...Ex:平日早上、平日下午"></div>
                            </div>
                            <div class="resume-item">
                ...
                <div class="avatar-section">
                    <div class="avatar-container">
                        <img src="https://fastly.picsum.photos/id/832/200/300.jpg?hmac=6gMt7WeRsS41_901ujRTrOgfwtW9MBZ375g8qXO3LUc" alt="">
                    </div>
                </div>
            </div>
            </form>
