							...
							<div class="container" style="width: 100%; background-color: black;">
								...
								<div class="row">
									...
									<div class="col-sm-8 col-sm-offset-1"
										...
										<div class="col-sm-12">
											<img style="width: 100%" src="html/assets/images/shop/MeetBoth.gif"
												alt="Title of Image" />
										</div>
										<div class="post">
											<!-- 							標題 -->
												...
												<div class="post-video embed-responsive embed-responsive-16by9"
													...
													<div>
														<span>網站名稱 :&ensp;</span><span id="MBSPAN">肉丸學習網
															...
															id="MBText" style="display: none;"> <input type="button"
															value="修改" class="MBbtn" id="MBUpDate">
													...
													<div>
														<span>網站首頁網址 :&ensp;</span><span><a href="#"
															...
															style="display: none; width: 500px;"> <input type="button"
															value="修改" class="MBbtn" id="webUpDate">
													...
													<div>
														<span>網站用戶人數(截至2023.01) :&ensp;</span><span
															id="MBSPAN">1742人</span>
													</div>
													<div>
