			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a
							href="/MeetBoth/_05_teacStu.searchAllTeac.controller/1">履歷貼文</a>
						</li>
						<li><a
							href="/MeetBoth/_05_teacStu.searchAllStud.controller/1">需求貼文</a>
						</li>
					</ul>
				</li>
				...
				<li class="dropdown"><a class="dropdown-toggle" href="#"
					...
					<ul class="dropdown-menu">
						<li class="dropdown"><a
							href="/MeetBoth/searchAllCourse.controller">線上課程目錄</a></li>
						<li class="dropdown"><a
							href="/MeetBoth/pathToSearchAllCourseMember.controller">我購買的課程</a></li>
					</ul></li>
				...
				<li class="dropdown"><a class="dropdown-toggle" href="#"
					...
					<ul class="dropdown-menu" role="menu">
						<li class="dropdown"><a
							href="/MeetBoth/_03_product.searchAllProduct.controller/1">商品目錄</a>
						</li>
						<li class="dropdown"><a class="dropdown-toggle" href="#"
							data-toggle="dropdown">熱門商品類別</a>
							<ul class="dropdown-menu">
								<li><a
									href="/MeetBoth/_03_product.searchProductByType.controller/1/1">學生用品</a></li>
								<li><a
									href="/MeetBoth/_03_product.searchProductByType.controller/1/2">教學用品</a></li>
								<li><a
									href="/MeetBoth/_03_product.searchProductByType.controller/1/6">好書推薦</a></li>
							</ul></li>
					</ul></li>
				...
				<li class="dropdown"><a class="dropdown-toggle" href=""
					...
					<ul class="dropdown-menu">
						<li><a
							href="/MeetBoth/_06_halaAndQa.SelectAllHala.controller/1">哈拉論壇</a>
						</li>
					</ul></li>
				...
				<li>
					...
					class="btn border"> <i
						class="fas fa-shopping-cart text-primary"></i> <c:if
							test="${not empty cartsize}">
							<span class="badge" id="cartCount">${cartsize}</span>
						</c:if> <c:if test="${empty cartsize}">
				...
				<li id="logoutBtn" class="nav-item dropdown"><a href="#"
					...
					<ul
						...
						<li>
							<form action="/MeetBoth/_01_member.membercenter.controller"
								method="post" id="memberCenter"></form> <a href="#"
