...
<html>
  <head>
    ...
    "/html/assets/css/main.css" ; %> <% String pathimg=request.getContextPath();
    String basePathimg=request.getScheme() + "://" + request.getServerName() +
    ":" + request.getServerPort() + pathimg + "/html/images/meatball-icon.png" ;
    %> <% String basePathimg2=request.getScheme() + "://" +
    request.getServerName() + ":" + request.getServerPort() + path +
            ...
            <div class="row">
              ...
              >
                <div class="col-sm-12">
                  <img
                    style="width: 100%"
                    src="html/assets/images/shop/MeetBoth.gif"
                    alt="Title of Image"
                  />
                </div>
                <div class="post">
                  ...
                  <div class="post">
                    ...
                    >
                      <div>
                        <span>網站名稱 :&ensp;</span
                        ><span id="MBSPAN">肉丸學習網 MeetBoth</span>
                        <input
                          type="text"
                          value=""
                          class="MBinput"
                      ...
                      <div>
                        <span>網站首頁網址 :&ensp;</span
                        ><span
                          ><a href="#" id="webSPAN"
                            >MeetBoth/index.controller</a
                          ></span
                        >
                        <input
                          type="text"
                      ...
                      <div>
                        <span>網站理念 :&ensp;</span
                        ><span id="MBSPAN">打造一個最方便的學習網</span>
                      </div>
                      <div>
                        <span>網站用戶人數(截至2023.01) :&ensp;</span
                        ><span id="MBSPAN">1742人</span>
                      </div>
                      <div>
                        <div id="columnchart_values" style=""></div>
                      </div>
                      <div>
                        <span>網站總瀏覽次數(2022.07至2023.01) :&ensp;</span
                        ><span id="MBSPAN">20,123次</span>
                      </div>
                      <div>
