            ...
            <div class="resume-body">
                <div class="resume-section">
                    ...
                    <div class="resume-table">
                        ...
                        <button onclick="window.location='/MeetBoth/_05_teacStu.searchAllTeac.controller/1'" style="display:flex; justify-content:center; align-items:center; margin:15px auto 0 auto" class="btn btn-b btn-circle" type="submit">返回上一頁</button>
                        </div>
                </div>
		...
		<div class="case-list">
            ...
            <div class="case-list-body">
                ...
                <form action="<c:url value='/_05_teacStu.insertreply.controller' />" method="Get">
					...
					<!-- 星星 -->
                	<textarea name="reply" class="form-control" rows="7" placeholder="Textarea"></textarea>
                	<button style="display:flex; justify-content:center; align-items:center; margin:15px auto 0 auto" class="btn btn-b btn-circle" type="submit">留言</button>
                </form>
                </div>
            </div>
        </div>
