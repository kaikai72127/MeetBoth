												...
												<div>
													<table style='margin: auto; width: 70%;'>
														...
														<tr style='border-style: outset; background-color: #FFFF6F'>
															...
															<td class="color-text" style="border-left: outset black">
																<h3>瀏覽次數</h3>
															</td>
															<td class="color-text" style="border-left: outset black">
																<h3>作者</h3>
															...
															<div>
																<form method="get"
																	...
																	<input type="submit" name="halaclassname" value="公告"
																		...
																		name="halaclassname" value="閱讀心得"
																		style="width: 17%">
																	<input type="submit" name="halaclassname"
																		value="資料分享" style="width: 17%"> <input
																		type="submit" name="halaclassname" value="圖書推薦"
																		style="width: 17%">
																	<input type="submit" name="halaclassname"
																		value="教學文章" style="width: 17%"> <input
																		type="submit" name="halaclassname" value="JAVA"
																		style="width: 17%">
																	<input type="submit" name="halaclassname"
																		value="HTML" style="width: 17%"> <input
																		type="submit" name="halaclassname"
																		value="Spring" style="width: 17%">
																	<input type="submit" name="halaclassname"
																		value="SpringBoot" style="width: 17%"> <input
																		type="submit" name="halaclassname"
																		value="SpringMVC" style="width: 17%">
																	<input type="submit" name="halaclassname"
																		value="SQL Server" style="width: 17%"> <input
																		type="submit" name="halaclassname"
																		value="My SQL" style="width: 17%">
																	<input type="submit" name="halaclassname"
																		value="Hibernate" style="width: 17%"> <input
																		type="submit" name="halaclassname"
																		value="VScode" style="width: 17%">
																	<input type="submit" name="halaclassname"
																		value="eclipse" style="width: 17%"> <input
																		type="submit" name="halaclassname"
																		value="SpringTool" style="width: 17%">
																	<input type="submit" name="halaclassname"
																		value="JDBC" style="width: 17%"> <input
																		type="submit" name="halaclassname"
																		value="Servlet" style="width: 17%">
																	<input type="submit" name="halaclassname"
																		value="JavaScript" style="width: 17%"> <input
																		type="submit" name="halaclassname"
																		value="jQuery" style="width: 17%">
																	<input type="submit" name="halaclassname"
																		value="Azure" style="width: 17%"> <input
																		type="submit" name="halaclassname"
																		value="RESTful" style="width: 17%">
																	<input type="submit" name="halaclassname"
																		value="c++" style="width: 17%"> <input
																		type="submit" name="halaclassname"
																		value="python" style="width: 17%">
