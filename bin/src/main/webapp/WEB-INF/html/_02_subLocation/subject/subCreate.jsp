			...
			<div class="inner">
				...
				<section>
					...
					<div class="table-wrapper">
						<div id='main'>
							<form action="<c:url value='/_02_subLocation.InsertSub.controller'/>"
								method='post'>

								<label>科目編號</label> <input type="text" name="subjectId"
									 placeholder="請填寫科目編號" required> <label>科目名稱</label>
								<input type="text" name="subjectName" 
									placeholder="請填寫科目名稱" required> <label>科目分類</label> <input
									type="text" name="subjectClass" 
