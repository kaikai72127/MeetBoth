								...
								<div class="row">
									...
									<div class="col-sm-8 col-sm-offset-1"
										...
										<div class="post">
											...
											<div class="post">
												<form
													action="<c:url value='/_03_product.MBupdateProdAction.controller' />"
													...
													<div class="post-video embed-responsive embed-responsive-16by9"
														...
														<div>
															<span>商品狀態 :&ensp;<input value="${prod.prodState}"
																	type="text" name="pst" class="MBinput"
																	placeholder="上架或下架"></span>
														</div>
														<div>
															<span>商品編號 :&ensp;<input value="${prod.prodID}" type="text"
																	name="pid" class="MBinput" placeholder="自動產生"
																	readonly></span>
														</div>
														<div>
															<span>商品名稱 :&ensp;<input value="${prod.prodName}"
																	type="text" name="pna" class="MBinput"
																	placeholder="不能為空"></span>
														</div>
														<div>
															<input type="hidden" value="${prod.prodtype.prodClass}"
																name="pClass">
															<span>商品類別 :&ensp;<select name="pty" style=""
																	class="MBinput">
														...
														<div>
															<span>商品價格 :&ensp;<input value="${prod.prodPrice}"
																	type="text" name="ppr" class="MBinput"
																	placeholder="只能數字"></span>
														</div>
														<div>
															<span>賣家編號 :&ensp;<input value="${prod.memberID}"
																	type="text" name="pmid" class="MBinput"
																	placeholder="只能編號"></span>
														</div>
														<div>
															<span>商品庫存 :&ensp;<input value="${prod.inventory}"
																	type="text" name="pinvt" class="MBinput"
																	placeholder="只能數字"></span>
														</div>
														<div>
															<span>上架時間 :&ensp;<input value="${prod.prodPost}"
																	type="text" name="ppo" class="MBinput"
																	placeholder="自動產生" readonly></span>
														</div>
														<div>
															<span>更新時間 :&ensp;<input value="${prod.prodUpdate}"
																	type="text" name="pup" class="MBinput"
																	placeholder="自動產生" readonly></span>
														</div>
														<div>
															<span>銷售數量 :&ensp;<input value="${prod.prodSales}"
																	type="text" name="pps" class="MBinput"
																	placeholder="只能數字"></span>
														</div>
														<div>
															<span>瀏覽次數 :&ensp;<input value="${prod.prodCheck}"
																	type="text" name="pch" class="MBinput"
																	placeholder="只能數字"></span>
														</div>
														<div style="display: flex;">
															<span>上傳商品照片</span>
														...
														<div>
															<textarea name="pdr"
																...
																placeholder="商品評論 可以不填">${prod.directions}</textarea>
														</div>
														<div>
