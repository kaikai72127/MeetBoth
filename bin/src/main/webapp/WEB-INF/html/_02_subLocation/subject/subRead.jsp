			...
			<div class="inner">
				...
				<section>
					...
					<section id="search" class="alt">
						<form action="<c:url value='/Servlet/subjectFindServlet' />" method="post" action="#">
							<input type="text" name="subclass" id="subclass" placeholder="Search" />
						</form>
					</section>
							...
							<c:forEach var="bean" items="${findByClassList}">
								<tbody>
									<tr>
										...
										<td><form method="post"
												action="<c:url value='/_02_subLocation.DeleteSub.controller' />">
												<button name="subNo" value="${bean.subjectId}">
