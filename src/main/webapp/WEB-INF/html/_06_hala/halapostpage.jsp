					...
					<section class="module">
						<div class="demo-container">
								...
								<div class="post-container">
									...
									<div class="post-section">
										<div class="post_headerdeo">
											<h2 style="font-size: 26px; padding-left: 15px; font-weight: bolder;">
												...
												<div class="post-author">
													...
													<div class="post-user">
														...
														<a href="" class="user-id"
															style="color: #FFFFFF;">@${bean.memberid}</a>
													</div>
												</div>
										...
										<div class="post-body">${bean.halacontent}
											<div style="position: absolute; z-index: 1; height: 20px; right: 400px">
										...
										<div class="post-footer">
													...
													<div class="reply-item">
														...
														<div class="reply-content">
															...
															<article class="reply-article">
																${respBean.responseHalaContent}</article>
															<div class="reply-content-detail">
																${respBean.responseHalaPostDate}</div>
														</div>
													</div>
												</c:forEach>
											</div>
											...
											<div id="div1" class="reply-editor">
												<input class="reply-article" id="textForRespHala"
													onkeypress="handleKeyPress(event)" type="text" placeholder="Reply">
											</div>
										</div>
									</div>
								</div>
							...
							<c:forEach var="answer" items="${bean.answerHala}">
								<input id="answerHalaIdHidden" type="hidden" value="${answer.answerId}" />
								<div class="post-container">
									<div class="user-section">
										<div class="user-card">
											<img src="https://picsum.photos/200/300" alt="">
									...
									<div class="post-section">
										...
										<div class="post-footer">
											...
											<div class="reply-list" id="fuckyoureplylist123">
												<!----------------------------------------------------回覆留言迴圈開始------------------------ -->
												<c:forEach var="respAnswerBean" items="${answer.responseAnswerBean}">
													<div class="reply-item">
														<div class="reply-avatar">
															<img src="https://picsum.photos/200" alt="">
														</div>
														<div class="reply-content">
															...
															<article class="reply-article">
																${respAnswerBean.responseAnswerContent}</article>
															<div class="reply-content-detail">
																${respAnswerBean.responseAnswerDate}</div>
														</div>
													</div>
												</c:forEach>
												<!-- -------------------------------------------------------------回覆留言迴圈結束------------------------ -->
											...
											<div id="div1" class="reply-editor">
												<input class="reply-article" id="textForRespAnswer"
													onkeypress="handleKeyPress2(event)" type="text" placeholder="Reply">
											</div>
										</div>
									</div>
								</div>
						...
						<div style='width: 80%; margin: 30px; position: relative;'>
							<div class="comment-form" style=' margin-left: 130px ;margin-top:0'>
								...
								<form action='<c:url value="/_06_halaAndQa.addAnswerHala.controller" />' method="post">
									<input type="hidden" name="hieId" value="${bean.halaId}">
									<div class="form-group">
										<textarea class="form-control" id="answerHalaContent" name="answerHalaContent"
											rows="4" placeholder="請寫入您的回覆"></textarea>
									</div>
