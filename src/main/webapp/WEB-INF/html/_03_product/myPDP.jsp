				...
				<main>
					...
					<div class="main">
						<section class="module" style="padding-top: 10px;">
							<div class="container">
								<div class="row">
									<div class="col-sm-4 col-md-3 sidebar" style="position: sticky; top: 100px;">
										<div class="widget">
															...
															<li class="clearfix"
																...
																<div class="widget-posts-body" style="font-size: 22px;">
																	...
																	<div class="widget-posts-meta"
																		...
																		<div
																			style="position: relative; left: 310; bottom: 30;display:grid;">
																			...
																			<button
																				class="btn btn-b btn-circle deleteThisProduct"
																				name="${prodBean.prodID}"
