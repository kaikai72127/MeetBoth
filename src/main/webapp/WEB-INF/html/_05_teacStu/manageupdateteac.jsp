						...
						<div class="col-sm-8 col-sm-offset-1"
							...
							<div class="post">
								...
								<div class="post-thumbnail"
									...
									<h1
										style="padding-bottom: 0px; margin-bottom: 0; text-align: center; font-size: 50px; color: white;">後臺管理-修改教師履歷</h1>
								</div>
								...
								<input name="views" type="hidden" value="${bean.views}">
									<div class="post-video embed-responsive embed-responsive-16by9"
										...
										<div>
											<span>學歷 :&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;<input name="highEdu" value="${bean.highEdu}" type="text" name="pna" class="MBinput" placeholder="請輸入您的學歷...Ex:銘傳大學財務金融學系" required></span>
										</div>
										<div>
											<span>家教經驗 :&ensp;&ensp;&ensp;&ensp;&ensp;<input name="studExp" value="${bean.studExp}" type="text" name="ppr" class="MBinput" placeholder="請輸入您的家教經驗...Ex:國中數學2年" required></span>
										</div>
										<div>
											<span>留學經驗 :&ensp;&ensp;&ensp;&ensp;&ensp;<input name="tutorExp" value="${bean.tutorExp}" type="text" name="pmid" class="MBinput" placeholder="請輸入您的留學經驗...Ex:美國念MBA2年" required></span>
										</div>
										<div>
											<span>語言能力 :&ensp;&ensp;&ensp;&ensp;&ensp;<input name="lanAbility" value="${bean.lanAbility}" type="text" name="pinvt" class="MBinput" placeholder="請輸入您的語言能力...Ex:英文:精通" required></span>
										</div>
										<div>
											<span>證照技能 :&ensp;&ensp;&ensp;&ensp;&ensp;<input name="skills" value="${bean.skills}" type="text" name="ppo" class="MBinput" placeholder="請輸入您的證照技能...Ex:國際專案管理師PMP" required></span>
										</div>
										<div>
											<span>授課科目 :&ensp;&ensp;&ensp;&ensp;&ensp;<input name="subjectItem" value="${bean.subjectItem}" type="text" name="pup" class="MBinput" placeholder="請輸入您的授課科目...Ex:英文、數學" required></span>
										</div>
										<div>
											<span>授課地區 :&ensp;&ensp;&ensp;&ensp;&ensp;<input name="teacLoc" value="${bean.teacLoc}" type="text" name="pps" class="MBinput" placeholder="請輸入您的授課地區...Ex:台北市、新北市" required></span>
										</div>
										<div>
											<span>授課對象 :&ensp;&ensp;&ensp;&ensp;&ensp;<input name="teacObject" value="${bean.teacObject}" type="text" name="pch" class="MBinput" placeholder="請輸入您的授課對象...Ex:國小、國中" required></span>
										</div>
										<div>
											<span>授課時段 :&ensp;&ensp;&ensp;&ensp;&ensp;<input name="teacTime" value="${bean.teacTime}" type="text" name="pch" class="MBinput" placeholder="請輸入您的授課時段...Ex:平日早上、平日下午" required></span>
										</div>
										<div>
											<span>授課模式 :&ensp;&ensp;&ensp;&ensp;&ensp;<input name="classMode" value="${bean.classMode}" type="text" name="pch" class="MBinput" placeholder="請輸入您的授課模式...Ex:面授、線上教學" required></span>
										</div>
										<div>
											<span>試教意願 :&ensp;&ensp;&ensp;&ensp;&ensp;<input name="willTeac" value="${bean.willTeac}" type="text" name="pch" class="MBinput" placeholder="請輸入您的試教意願...Ex:可試教或不方便試教" required></span>
										</div>
										<div>
											<span>聯絡方式 :&ensp;&ensp;&ensp;&ensp;&ensp;<input name="conMethod" value="${bean.conMethod}" type="text" name="pch" class="MBinput" placeholder="請輸入您的連絡方式...Ex:電話、郵件" required></span>
										</div>
										<div>
										...
										<div>
											<span>希望待遇 :&ensp;&ensp;&ensp;&ensp;&ensp;<input name="price" value="${bean.price}" type="text" name="pch" class="MBinput" placeholder="請輸入您的希望待遇...Ex:800" required></span>
										</div>
										<div>
