...
<body data-spy="scroll" data-target=".onpage-navigation"
		...
		<div class="main" style="background-color: #F0F0F0;">
				...
				<div class="container" style="">
					<form class="row"
						...
						<div class="col-sm-2 mb-sm-20"
							...
							<select name="typecase" class="form-control" style="font-size:17px">
						...
						<div class="col-sm-2 mb-sm-20"
							...
							<input class="form-control input-sm" type="text" name="lowprice"
								placeholder="0" value="0" style="text-align: center;font-size:17px"
						...
						<div class="col-sm-2 mb-sm-20"
							...
							<input class="form-control input-sm" type="text" name="highprice"
								placeholder="999999" value="999999" style="text-align: center;font-size:17px"
								onkeyup="value=value.replace(/[^\d]/g,'') " />
						</div>
						...
						<div class="col-sm-3" style="width: 10%">
							<button class="btn btn-d btn-round" type="submit" style="font-size:17px">搜尋</button>
						</div>
					</form>
				</div>
			</section>
			...
			<div class="container" style="padding: 10px 10px 20px 20px;">
              ...
              <li class="work-item illustration webdesign">
                  <div class="work-image"><a href="#"><img src="#" alt="Portfolio Item"/></a></div>
								...
								<div class="shop-item">
									...
									<div id="scoreAVG">
										<c:forEach var="commentBean" items="${bean.productComment}">
											...
											<strong style="font-size: 16px">商品評價 :&nbsp;</strong>
	...
	<script src="https://kit.fontawesome.com/25590258af.js"
		...
		document.addEventListener("DOMContentLoaded", function() {
			const scores = document.querySelectorAll("#scoreAVG");
			for (let i = 0; i < scores.length; i++) {
				const score = scores[i];
				const starAVGs = score.querySelectorAll("#starAVG");
				let totalScore = 0;
