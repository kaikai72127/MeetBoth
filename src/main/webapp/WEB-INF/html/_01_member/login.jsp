		...
		<% String pathAnimation=request.getContextPath(); String basePathAnimation=request.getScheme() + "://" +
			...
			<% String path=request.getContextPath(); String basePath=request.getScheme() + "://" +
				...
				<% String pathimg=request.getContextPath(); String basePathimg=request.getScheme() + "://" +
					request.getServerName() + ":" + request.getServerPort() + pathimg + "/html/images/meatball-icon.png"
					; %>
										...
										<div class="inner">
											...
											<section>
												...
												<div style="text-algin: center; padding-top: 12px; width:200px">
													<form action="<%=request.getContextPath()%>/login/page"
														method="post">
														使用者名稱：<input type="text" name="username" required>
														密碼：<input type="password" name="password" required><br>
														<div class="col-6 col-12-small">
															<input type="checkbox" id="demo-copy" name="remember-me">
															<label for="demo-copy">記住我</label>
														</div>
														<span style="display:flex;">
															<input type="submit" value="登入" style="margin-right:20px;">
									...
									<% String basePath2=request.getScheme() + "://" + request.getServerName() + ":" +
										...
										<% String basePath3=request.getScheme() + "://" + request.getServerName() + ":"
											...
											<% String basePath4=request.getScheme() + "://" + request.getServerName()
												...
												<% String basePath5=request.getScheme() + "://" +
