										...
										<div class="col-sm-12">
											<div class="price font-alt" style="display: flex;">
												...
												<input class="form-control input-lg" type="number"
													name="prodPrice" id="amount"
													required="required" value="${bean.prodPrice}"
													style="width: 80%; font-size: 20px; letter-spacing: 0px; border: 1px solid black; border-radius: 15px; text-align: center;" />
											</div>
										</div>
									</div>
									...
									<div class="row mb-20">
										<div class="col-sm-12">
											<div class="price font-alt" style="display: flex;">
												...
												<input class="form-control input-lg" type="text"
													name="memberID" required="required" value="${bean.memberID}" readonly
													style="width: 80%; font-size: 20px; letter-spacing: 0px; border: 1px solid black; border-radius: 15px; text-align: center;" />
											</div>
										</div>
									</div>
									<div class="row mb-20">
										<div class="col-sm-12">
											<div class="price font-alt" style="display: flex;">
												...
												<input class="form-control input-lg" type="number"
													name="inventory" id="amount"
													required="required" value="${bean.inventory}"
													style="width: 80%; font-size: 20px; letter-spacing: 0px; border: 1px solid black; border-radius: 15px; text-align: center;" />
											</div>
										</div>
									</div>
