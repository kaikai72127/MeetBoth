						...
						<div class="col-sm-8 col-sm-offset-1" style="margin-left: 20px;">
							<div class="post">
								<div class="post-thumbnail">
									<img src="/MeetBoth/html/assets/images/shop/個人平台.jpg"
										style="padding-bottom: 10px;">
								</div>
								<div class="post-header font-alt" style="display: flex;">
									<img style="" src="/MeetBoth/html/assets/images/shop/我的課程管理.jpg"
										style="padding-bottom: 10px;">
								</div>
								<!--       動態搜尋列 -->
								<section class="module-small"
									...
									<div class="container" style="">
										<form class="row"
											action="<c:url value='/searchCourseWithCondition2.controller'/>"
											method="post">
								...
								<div class="post-entry"
									style="overflow-y: scroll; overflow-x: hidden; width: 115%; height: 720px;">
									<div class="widget">
											...
											<c:forEach var="courseBean" items="${memberBean.course}">
												<li class="clearfix"
													...
													<div class="widget-posts-image"
														...
														<a
															href="<c:url value='/PathToCourseDetail.controller?id=${courseBean.courseID}' />"
															style="margin: auto; display: flex; justify-content: center; align-items: center;"><img
															style="padding: auto;"
															src="<c:url value='/showCoursePicture.controller?id=${courseBean.courseID}' />" /></a>
													</div>
													<div class="widget-posts-body" style="font-size: 22px;">
														<div class="widget-posts-title">
															<a
																href="<c:url value='/PathToCourseDetail.controller?id=${courseBean.courseID}' />">課程名稱
																: ${courseBean.courseName}</a>
														</div>
														<div class="widget-posts-meta"
															style="display: flex; height: 38px;">
															課程類別 : ${courseBean.coursetype.courseClassName}
															<div
																style="position: relative; left: 270; bottom: 30; display: grid;">
																<button class="btn btn-b btn-circle"
																	style="font-size: 17px; margin-bottom: 10px;"
																	onclick="window.location='/MeetBoth/pathToInsertYtPlayer.controller?id=${courseBean.courseID}'">新增影片</button>
																<button class="btn btn-b btn-circle"
																	style="font-size: 17px; margin-bottom: 10px;"
																	onclick="window.location='/MeetBoth/catchSingleCourse.controller?id=${courseBean.courseID}'">修改</button>
																<button class="btn btn-b btn-circle deleteThisProduct"
																	name="${courseBean.courseID}" style="font-size: 17px;">刪除</button>
															</div>
														</div>
														<div class="widget-posts-meta" style="display: flex">
															課程價格 : NT$${courseBean.coursePrice}</div>
														<div id="scoreAVG" class="widget-posts-meta">
															<c:forEach var="commentBean"
																items="${courseBean.courseComment}">
																<input type="hidden" id="starAVG"
																	value="${courseComment.courseScore}">
															</c:forEach>
