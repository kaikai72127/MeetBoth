										...
										<div class="col-sm-12">
											<ul class="nav nav-tabs font-alt" role="tablist">
												...
												<li><a href="#data-sheet" data-toggle="tab"
														style="font-size: 17px;"><span
															class="icon-tools-2"></span>商品簡介</a></li>
												<li><a href="#reviews" data-toggle="tab" style="font-size: 17px;"><span
															class="icon-tools-2"></span>商品頻論(commentAmount)</a></li>
											</ul>
													...
													<div style="display: flex;">
														...
														<div class="comment-content clearfix"
															...
															<div class="comment-author font-alt">
																<h3>
																	<a href="#">${bean.memberBean.memNickName}</a><span
																		style="font-size:17px">(${bean.memberBean.account})</span>
																</h3>
																<p style="font-size: 20px;"></p>
																<p style="font-size: 20px;">E-mail :
																	${bean.memberBean.eMail}</p>
																<p style="font-size: 20px;">Phone :
																	${bean.memberBean.phone}</p>
															</div>
														</div>
														<div style="margin-top: 170px;">
															<a
																href="<c:url value='/memberresume?id=${bean.memberBean.memberID}'/>"><input
																	class="btn btn-d btn-circle" type="button"
																	value="前往賣家個人頁面"
																	style="height: 43px; font-size: 19px; float: right;"></a>
														</div>
													</div>
												</div>
												<!-- 	賣家資訊 end-->
																...
																<div class="comment clearfix">
																	...
																	<div class="comment-content clearfix">
																		<div class="comment-author font-alt"
																			style="margin: 0;">
																			<a href="#"
																				style="font-size: 15px;">${commbean.memberBean.memNickName}</a>
																		</div>
										...
										<div class="col-sm-6 col-md-3 col-lg-3">
											<div class="shop-item">
												<div class="shop-item-image"
													...
													<img src="<c:url value='/_03_product.showPicture.controller?id=${prodLikeBean.prodID}' />"
														alt="Cold Garb" />
													<div class="shop-item-detail">
														<a href="/MeetBoth/_03_product.PathToProductDetail.controller?id=${prodLikeBean.prodID}"
