	...
	<main>
		...
		<section style="margin-top: 110px; margin-bottom: 120px">
			...
			<div class="container"
				...
				<h2>${CourseOrder.memberbuy.memName}先生/小姐 感謝您的訂購</h2>
				<h3 style="margin-bottom: 35px">已收到您的訂單，您訂購了 ${CourseOrder.courseBean.courseName} 課程。</h3>
				<h3 style="margin-bottom: 35px">我們現在就立即上課吧</h3>
