			...
			<body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
				<main>
					...
					<div class="main" style="background-color: #F0F0F0;">
						...
						<form action="<c:url value='/_03_product.insertProduct.controller' />" method="post"
								...
								<div class="container">
									<div class="row">
										...
										<div class="col-sm-6 mb-sm-40" style="width: 42%;">
											<span class="amount">上傳商品照片</span> <input type="file" name="pPic"
												id="images5278" style="width: 80%" accept=".jpg,.png"> <img id="preImg"
												style="" src="#" />
										</div>
										<!-- 							圖片右邊BLOCK -->
											...
											<div class="row mb-20">
												<div class="col-sm-12">
													<div class="price font-alt" style="display: flex;">
														...
														<input class="form-control input-lg" type="number" name="pPrice"
															id="amount" value="1" min="0" required="required"
															style="width: 80%; font-size: 20px; letter-spacing: 0px; border: 1px solid black; border-radius: 15px; text-align: center;" />
													</div>
												</div>
											</div>
											...
											<div class="row mb-20">
												<div class="col-sm-12">
													<div class="price font-alt" style="display: flex;">
														...
														<input class="form-control input-lg" type="number" name="invt"
															id="amount" value="1" min="0" required="required"
															style="width: 80%; font-size: 20px; letter-spacing: 0px; border: 1px solid black; border-radius: 15px; text-align: center;" />
													</div>
												</div>
										...
										<div class="row mb-20">
											<div class="col-sm-12">
												<div class="price font-alt" style="">
													...
													<textarea class="form-control" id="directions" name="directions"
														placeholder="商品介紹"
