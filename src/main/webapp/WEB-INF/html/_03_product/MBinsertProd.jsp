              ...
              />
						...
						<div class="col-sm-8 col-sm-offset-1"
							...
							<div class="post">
								...
								<div class="post">
									<form
										action="<c:url value='/admin/_03_product.MBinsertProdAction.controller' />"
										...
										<div
											...
											<div style="display: flex">
												<input type="button" class="MBbtn"
													onclick="window.location='/MeetBoth/admin/_03_product.productindex.controller/1'"
													value="返回">
											</div>
											<div>
											...
											<div>
												<span>銷售數量 :&ensp;<input type="text" name="pps"
													class="MBinput" value="0" readonly></span>
											</div>
											<div>
