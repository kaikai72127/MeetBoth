		...
		<div id="main">
			<div class="inner">
				...
				<!-- Content -->
					...
					<div>
						<a
							href="<c:url value='/_03_product.searchAllProduct2.controller'/>">
					...
					<div class="table-wrapper">
						...
						<div id="prodMenu">
							<c:forEach var="bean" items="${allprodlist}">
								<div id="eachProdBlock" class="mEvent" onclick="window.location='/SpringBoot_Team5/_03_product.PathToProductDetail.controller?id=${bean.prodID}'">
									<div id="photo">
										<a
											href="<c:url value='/_03_product.PathToProductDetail.controller?id=${bean.prodID} '/>">
											<img id="img"
