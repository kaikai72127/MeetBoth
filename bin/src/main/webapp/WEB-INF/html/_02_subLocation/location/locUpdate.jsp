			...
			<div class="inner">
				...
				<section>
					...
					<div class="table-wrapper">
						<div id='main'>
						<form action="<c:url value='/_02_subLocation.UpdateLoc.controller'/>"
							 method='post'>
							<Table>
								<c:forEach var="bean" items="${classList}">
									<tr height="30">
										<td style="width: 120px;"><label class="fontSize">地點編號：</label><br>&nbsp;</td>
										<td><input type='text'
											readonly="readonly" name='locno' value="${bean.locno}"
											class="fieldWidth" style="width: 200px;" /><br>&nbsp; <font
											color="red" size="-1">${MsgMap.errorIdEmpty}${MsgMap.errorIdDup}</font></td>
										<td style="width: 120px;"><label class="fontSize">地點名稱：</label><br>&nbsp;</td>
										<td><input type='text' name='locname'
											value="${bean.locname}" class="fieldWidth"
											style="width: 200px;" /><br>&nbsp; <font color="red"
											size="-1">${MsgMap.errorName}</font></td>
										<td style="width: 120px;"><label class="fontSize">地點分類：</label><br>&nbsp;</td>
										<td><input type='text' name='locclass'
											value="${bean.locclass}" class="fieldWidth"
											style="width: 200px;" /><br>&nbsp; <font color="red"
