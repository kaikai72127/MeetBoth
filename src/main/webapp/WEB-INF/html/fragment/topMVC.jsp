        ...
        <div class="container-nav">
          ...
          <div class="collapse navbar-collapse" id="custom-collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <!--Navbar橫幅 隨堂測驗 -->
              <li class="dropdown">
                <a class="dropdown-toggle" href="#" data-toggle="dropdown">隨堂測驗</a>
                <ul class="dropdown-menu">
                  <li><a href="#" data-toggle="dropdown">會員資料數據</a></li>
                  <li class="dropdown">
                    <a class="dropdown-toggle" href="#" data-toggle="dropdown">會員管理</a>
                    <ul class="dropdown-menu">
                      <li>
                        <a href="index_mp_fullscreen_flexslider.html">會員查詢</a>
                      </li>
              ...
              <!--Navbar橫幅 Shop -->
              <li class="dropdown">
                <a class="dropdown-toggle" href="#" data-toggle="dropdown">地圖搜尋</a>
              ...
              <!--Navbar橫幅 Prorfolio -->
              <li class="dropdown">
                <a class="dropdown-toggle" href="#" data-toggle="dropdown">買賣專區</a>
                <ul class="dropdown-menu" role="menu">
                  <li class="dropdown">
              ...
              <!--Navbar橫幅 Blog -->
              <li class="dropdown">
                <a class="dropdown-toggle" href="#" data-toggle="dropdown">哈拉討論區</a>
                <ul class="dropdown-menu" role="menu">
                  <li class="dropdown">
                    <a class="dropdown-toggle" href="#" data-toggle="dropdown">隨便聊聊</a>
                    <ul class="dropdown-menu">
                      <li>
                  ...
                  <li class="dropdown">
                    <a class="dropdown-toggle" href="#" data-toggle="dropdown">我有問題</a>
                    <ul class="dropdown-menu">
