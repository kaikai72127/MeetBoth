<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		<% String pathAnimation=request.getContextPath(); String basePathAnimation=request.getScheme() + "://" +
			request.getServerName() + ":" + request.getServerPort() + pathAnimation + "/html/assets/css/animation.css" ;
			%>
			<% String path=request.getContextPath(); String basePath=request.getScheme() + "://" +
				request.getServerName() + ":" + request.getServerPort() + path + "/html/assets/css/style.css" ;
				System.out.println(basePath); %>
				<% String baseColor=request.getScheme() + "://" + request.getServerName() + ":" +
					request.getServerPort() + path + "/html/assets/css/colors/default.css" ;
					System.out.println(baseColor); %>
					<% String pathBootstrap=request.getContextPath(); String baseBootstrap=request.getScheme() + "://" +
						request.getServerName() + ":" + request.getServerPort() + path
						+ "/html/assets/lib/bootstrap/dist/css/bootstrap.min.css" ; System.out.println(baseBootstrap);
						%>
						<% String pathAnimate=request.getContextPath(); String baseAnimate=request.getScheme() + "://" +
							request.getServerName() + ":" + request.getServerPort() + path
							+ "/html/assets/lib/animate.css/animate.css" ; System.out.println(baseAnimate); %>
							<% String pathComponents=request.getContextPath(); String baseComponents=request.getScheme()
								+ "://" + request.getServerName() + ":" + request.getServerPort() + path
								+ "/html/assets/lib/components-font-awesome/css/font-awesome.min.css" ;
								System.out.println(baseComponents); %>
								<% String pathEt=request.getContextPath(); String baseEt=request.getScheme() + "://" +
									request.getServerName() + ":" + request.getServerPort() + path
									+ "/html/assets/lib/et-line-font/et-line-font.css" ; System.out.println(baseEt); %>

									<% String baseFlexslider=request.getScheme() + "://" + request.getServerName() + ":"
										+ request.getServerPort() + path + "/html/assets/lib/flexslider/flexslider.css"
										; System.out.println(baseFlexslider); %>

										<% String baseOwl=request.getScheme() + "://" + request.getServerName() + ":" +
											request.getServerPort() + path
											+ "/html/assets/lib/owl.carousel/dist/assets/owl.carousel.min.css" ;
											System.out.println(baseOwl); %>

											<% String baseOwlDefault=request.getScheme() + "://" +
												request.getServerName() + ":" + request.getServerPort() + path
												+ "/html/assets/lib/owl.carousel/dist/assets/owl.theme.default.min.css"
												; System.out.println(baseOwlDefault); %>

												<% String baseMagnificPopup=request.getScheme() + "://" +
													request.getServerName() + ":" + request.getServerPort() + path
													+ "/html/assets/lib/magnific-popup/dist/magnific-popup.css" ;
													System.out.println(baseMagnificPopup); %>

													<% String baseSimpletextrotator=request.getScheme() + "://" +
														request.getServerName() + ":" + request.getServerPort() + path
														+ "/html/assets/lib/simple-text-rotator/simpletextrotator.css" ;
														System.out.println(baseSimpletextrotator); %>

														<% String pathimg=request.getContextPath(); String
															baseMeetbothIcon24x24=request.getScheme() + "://" +
															request.getServerName() + ":" + request.getServerPort() +
															pathimg
															+ "/html/assets/images/meatball/meatball-24x24-New.png" ;
															System.out.println(baseMeetbothIcon24x24); %>
															<% String baseMeetboth96x96=request.getScheme() + "://" +
																request.getServerName() + ":" + request.getServerPort()
																+ path
																...
																<link id="color-scheme" href="<%=baseColor%>"
																	rel="stylesheet" />
																<!-- 動畫css -->
