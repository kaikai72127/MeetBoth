							...
							<form action='<c:url value="/_05_teacStu.insertdata.controller" />' enctype='multipart/form-data' method='post'>
								<table class="alt">
									<thead>
										...
										<br>
										<img id="preImg" style="width:150px; height:200px" src="<%=basePathimg2%>" />
										</td></tr>
									</thead>
									...
									<input type="button" value="取消" onclick="location.href='http://localhost:8080/SpringBoot_Team5/_05_teacStu.searchAllTeac.controller'">
									</div>
									</form>
							</div>
				</section>
