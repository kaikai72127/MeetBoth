                    ...
                    <div class="page-container">
                        <div class="list">
                            ...
                            <div class="post-header font-alt">
                                ...
                                <form action="<c:url value='/_05_teacStu.insertdataMain.controller' />"><button
                                        style="float:right" class="btn btn-b btn-circle" type="submit">成為教師</button>
                                </form>
                            </div>
                            <!-- 標題結束 -->
                            ...
                            <div>
                                <div>
                                    <form method="post"
                                        ...
                                        <select name="case" onchange="this.form.submit()" style="width: 17%">
                            ...
                            <div class="pagination font-alt"
                                ...
                                <c:if test="${currentPage != 1}">
                                    <a href="/MeetBoth/_05_teacStu.searchAllTeac.controller/${currentPage-1}"><i
