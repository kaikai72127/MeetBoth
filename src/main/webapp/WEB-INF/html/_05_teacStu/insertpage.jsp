...
<body data-spy="scroll" data-target=".onpage-navigation"
	...
	<!-- 內容-履歷表 -->
        ...
        <div class="resume-container">
            ...
            <form action='<c:url value="/_05_teacStu.insertdata.controller" />' enctype='multipart/form-data' method='post'>
                ...
                <div class="resume-section">
                    ...
                    <div class="resume-table">
                        <div class="resume-item">
                            ...
                            <div class="resume-item-content"><input name="highEdu" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的學歷...Ex:銘傳大學財務金融學系"></div>
                        </div>
                        <div class="resume-item">
                            <div class="resume-item-title">家教經驗</div>
                            <div class="resume-item-content">
                                <input name="studExp" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的家教經驗...Ex:國中數學2年">
                            </div>
                        </div>
                        <div class="resume-item">
                            <div class="resume-item-title">留學經驗</div>
                            <div class="resume-item-content"><input name="tutorExp" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的留學經驗...Ex:美國念MBA2年"></div>
                        </div>
                        <div class="resume-item">
                            <div class="resume-item-title">語言能力</div>
                            <div class="resume-item-content"><input name="lanAbility" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的語言能力...Ex:英文:精通"></div>
                        </div>
                        <div class="resume-item">
                            <div class="resume-item-title">證照技能</div>
                            <div class="resume-item-content"><input name="skills" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的證照技能...Ex:國際專案管理師PMP"></div>
                        </div>
                    </div>
                    ...
                    <div class="resume-table">
                        <div class="resume-table">
                            <div class="resume-item">
                                ...
                                <div class="resume-item-content"><input name="subjectItem" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的授課科目...Ex:英文、數學"></div>
                            </div>
                            <div class="resume-item">
                                <div class="resume-item-title">授課地區</div>
                                <div class="resume-item-content"><input name="teacLoc" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的授課地區...Ex:台北市、新北市"></div>
                            </div>
                            <div class="resume-item">
                                <div class="resume-item-title">授課對象</div>
                                <div class="resume-item-content"><input name="teacObject" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的授課對象...Ex:國小、國中"></div>
                            </div>
                            <div class="resume-item">
                                <div class="resume-item-title">授課時段</div>
                                <div class="resume-item-content"><input name="teacTime" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的授課時段...Ex:平日早上、平日下午"></div>
                            </div>
                            <div class="resume-item">
                                <div class="resume-item-title">授課模式</div>
                                <div class="resume-item-content"><input name="classMode" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的授課模式...Ex:面授、線上教學"></div>
                            </div>
                            <div class="resume-item">
                                <div class="resume-item-title">試教意願</div>
                                <div class="resume-item-content"><input name="willTeac" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的試教意願...Ex:可試教或不方便試教"></div>
                            </div>
                            <div class="resume-item">
                                <div class="resume-item-title">聯絡方式</div>
                                <div class="resume-item-content"><input name="conMethod" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的連絡方式...Ex:電話、郵件"></div>
                            </div>
                            <div class="resume-item">
                                <div class="resume-item-title">聯絡時間</div>
                                <div class="resume-item-content"><input name="conTime" style="width:500%" class="form-control input-sm" type="text" placeholder="請輸入您的聯絡時間...Ex:平日早上、平日下午"></div>
                            </div>
                            <div class="resume-item">
